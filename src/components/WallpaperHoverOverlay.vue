<template>
  <div
    class="flex h-full min-h-0 w-full flex-col rounded-[clamp(22px,1vw,36px)] border border-white/25 bg-black/50 px-4 pb-4 pt-4 shadow-[inset_0_1px_0_rgba(255,255,255,0.25),0_0_0_1px_rgba(255,255,255,0.06)] max-[899px]:rounded-[12px] max-[899px]:px-3 max-[899px]:pb-3 max-[899px]:pt-3 min-[900px]:justify-end"
  >
    ...
    >
      <div class="flex w-full min-w-0 justify-center pb-1">
        <div
          class="flex max-w-full flex-wrap justify-center gap-1.5 min-[900px]:gap-x-2 min-[900px]:gap-y-1.5"
        >
          <span
    ...
    >
      ...
      >
        <span
          class="inline-flex min-w-0 items-center gap-1.5 max-[899px]:gap-1"
        >
          <svg
            class="h-4 w-4 shrink-0 max-[899px]:h-3.5 max-[899px]:w-3.5"
        ...
        <span
          class="hidden min-w-0 items-center gap-1.5 min-[900px]:inline-flex"
        >
          <svg
